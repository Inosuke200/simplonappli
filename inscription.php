...
<!DOCTYPE html>
    <html lang="en">
        ...
        <body>
            <div class="container">
                <h1 class="py-3">Créer votre compte</h1>
                            ...
                            if(filter_var($email, FILTER_VALIDATE_EMAIL))
                            {
                                if($password == $password_r)
                                {
                                    ...
                                    if($row == 0)
                                    {
                                        ...
                                        $insert = $bdd->prepare('INSERT INTO utilisateurs (nom, prenom, email, password, password_repeat) VALUES (?, ?, ?, ?, ?)');
                                        $insert->execute(array($nom, $prenom, $email, $password, $_SERVER['REMOTE_ADDR']));
